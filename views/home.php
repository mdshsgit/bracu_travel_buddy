...
<head>
    ...
    <title>BracU Travel Buddy</title>
</head>
...
<body class="bg-gray-100">
    ...
    <header class="bg-blue-900 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-3xl font-semibold">
                <a href="index.html">BracU Travel Buddy</a>
            </h1>
            <nav class="space-x-4">
                ...
                <a
                    href="post-job.html"
                    class="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded hover:shadow-md transition duration-300"><i class="fa fa-edit"></i> Create Post</a>
            </nav>
        </div>
    </header>
    ...
    <section
        ...
        <div class="container mx-auto text-center z-10">
            <h2 class="text-4xl text-white font-bold mb-4">Find your travel buddy</h2>
    ...
    <section class="bg-blue-900 text-white py-6 text-center">
        <div class="container mx-auto">
            <h2 class="text-3xl font-semibold">Discover new options</h2>
            <p class="text-lg mt-2">
                Discover the perfect travel partner for you.
            </p>
        </div>
    </section>
    ...
    <section>
        <div class="container mx-auto p-4 mt-4">
            <div class="text-center text-3xl mb-4 font-bold border border-gray-300 p-3">Recent Posts</div>
